...
public final class Commons extends FunckyLibrary {
    ...
    public final HigherOrderFunction number = new HigherOrderFunction(engine, STRING, NUMBER) {
        ...
        public FunckyNumber apply(final FunckyContext context, final List<FunckyExpression> arguments) {
                ...
                try {
                    ...
                    throw new SneakyRuntimeException(String.format(ERROR_INVALID_NUMBER, value), context);
                }
        }
    };
    public final HigherOrderFunction error = new HigherOrderFunction(engine, STRING, engine -> a) {
        @Override
        public FunckyValue apply(final FunckyContext context, final List<FunckyExpression> arguments) {
            throw new SneakyRuntimeException(arguments.getFirst().eval(context).toString(), context);
        }
    };
