...
public final class Characters extends FunckyLibrary {
    ...
    public final HigherOrderFunction $uppercase = new HigherOrderFunction(this, CHARACTER, CHARACTER) {
        @Override
        protected FunckyCharacter apply(final List<FunckyExpression> arguments) {
            return new FunckyCharacter(Character.toUpperCase(((FunckyCharacter) arguments.getFirst().eval())
                    .getValue()));
        }
    };
    public final HigherOrderFunction $lowercase = new HigherOrderFunction(this, CHARACTER, CHARACTER) {
        ...
        protected FunckyCharacter apply(final List<FunckyExpression> arguments) {
            return new FunckyCharacter(
                    Character.toLowerCase(((FunckyCharacter) arguments.getFirst().eval()).getValue()));
        }
    };
    public final HigherOrderFunction $number = new HigherOrderFunction(this, CHARACTER, NUMBER) {
        ...
        protected FunckyNumber apply(final List<FunckyExpression> arguments) {
            return new FunckyNumber(new BigDecimal(((FunckyCharacter) arguments.getFirst().eval()).getValue()));
        }
    };
    public final HigherOrderFunction $character = new HigherOrderFunction(this, NUMBER, CHARACTER) {
        @Override
        protected FunckyCharacter apply(final List<FunckyExpression> arguments) {
            final FunckyNumber codePointNumber = (FunckyNumber) arguments.getFirst().eval();
