...
public final class FunckyList extends FunckyValue implements Comparable<FunckyList> {
    ...
    public boolean equals(final Object object) {
            return (object instanceof FunckyList) && ((head == null) ? (((FunckyList) object).head == null)
                    : ((((FunckyList) object).head != null) && head.eval()
                            .equals(((FunckyList) object).head.eval())))
                    && ((tail == null) ? (((FunckyList) object).tail == null)
                    : ((((FunckyList) object).tail != null) && tail.eval()
                            .equals(((FunckyList) object).tail.eval())));
    }

    @Override
    public int hashCode() {
        return ((head == null) ? 0 : head.eval().hashCode()) + ((tail == null) ? 0
                : tail.eval().hashCode());
    }
