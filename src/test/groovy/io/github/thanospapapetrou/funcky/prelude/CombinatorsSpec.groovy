...
class CombinatorsSpec extends BaseSpec {
    ...
    def 'Test s'(final String expression, final FunckyValue result) {
        ...
        '"funcky:commons".string ("funcky:combinators".s ("funcky:commons".error "foo"))'                                                                                                                                                                               || engine.toFuncky('"funcky:combinators".s ("funcky:commons".error "foo")')
        ...
        '"funcky:commons".string ("funcky:combinators".s "funcky:numbers".add ("funcky:commons".error "foo"))'                                                                                                                                                          || engine.toFuncky('"funcky:combinators".s "funcky:numbers".add ("funcky:commons".error "foo")')
    ...
    def 'Test k'(final String expression, final FunckyValue result) {
        ...
        '"funcky:commons".string ("funcky:combinators".k ("funcky:commons".error "foo"))'                                                                                                         || engine.toFuncky('"funcky:combinators".k ("funcky:commons".error "foo")')
    ...
    def 'Test i'(final String expression, final FunckyValue result) {
        ...
        where:
        expression                                                                                                                                                        || result
        '"funcky:commons".string ("funcky:combinators".i)'                                                                                                                || engine.toFuncky('"funcky:combinators".s "funcky:combinators".k "funcky:combinators".k')
    ...
    def 'Test b'(final String expression, final FunckyValue result) {
        ...
        where:
        expression                                                                                                                                                                                                                                                      || result
        '"funcky:commons".string "funcky:combinators".b'                                                                                                                                                                                                                || engine.toFuncky('"funcky:combinators".s ("funcky:combinators".k "funcky:combinators".s) "funcky:combinators".k')
    ...
    def 'Test c'(final String expression, final FunckyValue result) {
        ...
        where:
        expression                                                                                                                                                                                                                                                      || result
        '"funcky:commons".string "funcky:combinators".c'                                                                                                                                                                                                                || engine.toFuncky('"funcky:combinators".s ("funcky:combinators".s ("funcky:combinators".k ("funcky:combinators".s ("funcky:combinators".k "funcky:combinators".s) "funcky:combinators".k)) "funcky:combinators".s) ("funcky:combinators".k "funcky:combinators".k)')
    ...
    def 'Test w'(final String expression, final FunckyValue result) {
        ...
        where:
        expression                                                                                                                                                                                                                                || result
        '"funcky:commons".string "funcky:combinators".w'                                                                                                                                                                                          || engine.toFuncky('"funcky:combinators".s "funcky:combinators".s ("funcky:combinators".s "funcky:combinators".k)')
