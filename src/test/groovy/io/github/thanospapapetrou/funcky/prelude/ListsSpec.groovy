...
class ListsSpec extends BaseSpec {
    ...
    def 'Test reduce'(final String expression, final FunckyValue result) {
        ...
        '"funcky:commons".equal ("funcky:types".domain ("funcky:types".range ("funcky:types".domain ("funcky:types".range ("funcky:types".type "funcky:lists".reduce))))) ("funcky:types".range ("funcky:types".range ("funcky:types".domain ("funcky:types".range ("funcky:types".type "funcky:lists".reduce)))))' || FALSE.apply(engine) // TODO this should be true
