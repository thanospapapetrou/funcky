...
class ListsSpec extends BaseSpec {
    ...
    def 'Test tail'(final String expression, final FunckyValue result) {
        ...
        '"funcky:lists".tail "a"'                                                                                                                                                                                     || engine.toFuncky('')
        '"funcky:lists".tail "ab"'                                                                                                                                                                                    || engine.toFuncky('b')
    }
    ...
    def 'Test prepend'(final String expression, final FunckyValue result) {
        ...
        '"funcky:commons".string ("funcky:lists".prepend ("funcky:commons".error "foo"))'                                                                                                                                                          || engine.toFuncky('"funcky:lists".prepend ("funcky:commons".error "foo")')
        ...
        '"funcky:lists".prepend "" \'a\''                                                                                                                                                                                                          || engine.toFuncky('a')
        '"funcky:lists".prepend "b" \'a\''                                                                                                                                                                                                         || engine.toFuncky('ab')
    }
    ...
    def 'Test append'(final String expression, final FunckyValue result) {
        ...
        '"funcky:lists".append "" \'a\''                                                                                                                                                                                                         || engine.toFuncky('a')
        '"funcky:lists".append "b" \'a\''                                                                                                                                                                                                        || engine.toFuncky('ba')
    }
    ...
    def 'Test concat'(final String expression, final FunckyValue result) {
        ...
        '"funcky:lists".concat "" ""'                                                                                                                                                                                                             || engine.toFuncky('')
        '"funcky:lists".concat "" "a"'                                                                                                                                                                                                            || engine.toFuncky('a')
        '"funcky:lists".concat "a" ""'                                                                                                                                                                                                            || engine.toFuncky('a')
        '"funcky:lists".concat "a" "b"'                                                                                                                                                                                                           || engine.toFuncky('ab')
    }
    ...
    def 'Test singleton'(final String expression, final FunckyValue result) {
        ...
        '"funcky:lists".singleton \'a\''                                                                                                                                                               || engine.toFuncky('a')
    }
    ...
    def 'Test empty'(final String expression, final FunckyValue result) {
        ...
        where:
        expression                                                                                                                || result
        '"funcky:commons".string "funcky:lists".empty'                                                                            || engine.toFuncky('"funcky:commons".equal []')
    ...
    def 'Test filter'(final String expression, final FunckyValue result) {
        ...
        '"funcky:lists".filter "" ("funcky:commons".equal \'a\')'                                                                                                                                                                                || engine.toFuncky('')
        '"funcky:lists".filter "a" ("funcky:commons".equal \'a\')'                                                                                                                                                                               || engine.toFuncky('a')
        '"funcky:lists".filter "b" ("funcky:commons".equal \'a\')'                                                                                                                                                                               || engine.toFuncky('')
        '"funcky:lists".filter "aa" ("funcky:commons".equal \'a\')'                                                                                                                                                                              || engine.toFuncky('aa')
        '"funcky:lists".filter "ab" ("funcky:commons".equal \'a\')'                                                                                                                                                                              || engine.toFuncky('a')
        '"funcky:lists".filter "ba" ("funcky:commons".equal \'a\')'                                                                                                                                                                              || engine.toFuncky('a')
        '"funcky:lists".filter "bb" ("funcky:commons".equal \'a\')'                                                                                                                                                                              || engine.toFuncky('')
    ...
    def 'Test map'(final String expression, final FunckyValue result) {
        ...
        '"funcky:lists".map "" "funcky:characters".uppercase'                                                                                                                                                                                                   || engine.toFuncky('')
        '"funcky:lists".map "a" "funcky:characters".uppercase'                                                                                                                                                                                                  || engine.toFuncky('A')
        '"funcky:lists".map "ab" "funcky:characters".uppercase'                                                                                                                                                                                                 || engine.toFuncky('AB')
    ...
    def 'Test take'(final String expression, final FunckyValue result) {
        ...
        '"funcky:lists".take "" 0'                                                                                                                                                                                                           || engine.toFuncky('')
        '"funcky:lists".take "" 1'                                                                                                                                                                                                           || engine.toFuncky('')
        '"funcky:lists".take "a" 0'                                                                                                                                                                                                          || engine.toFuncky('')
        '"funcky:lists".take "a" 1'                                                                                                                                                                                                          || engine.toFuncky('a')
        '"funcky:lists".take "a" 2'                                                                                                                                                                                                          || engine.toFuncky('a')
        '"funcky:lists".take "ab" 0'                                                                                                                                                                                                         || engine.toFuncky('')
        '"funcky:lists".take "ab" 1'                                                                                                                                                                                                         || engine.toFuncky('a')
        '"funcky:lists".take "ab" 2'                                                                                                                                                                                                         || engine.toFuncky('ab')
        '"funcky:lists".take "ab" 3'                                                                                                                                                                                                         || engine.toFuncky('ab')
    ...
    def 'Test drop'(final String expression, final FunckyValue result) {
        ...
        '"funcky:lists".drop "" 0'                                                                                                                                                                                                           || engine.toFuncky('')
        '"funcky:lists".drop "" 1'                                                                                                                                                                                                           || engine.toFuncky('')
        '"funcky:lists".drop "a" 0'                                                                                                                                                                                                          || engine.toFuncky('a')
        '"funcky:lists".drop "a" 1'                                                                                                                                                                                                          || engine.toFuncky('')
        '"funcky:lists".drop "a" 2'                                                                                                                                                                                                          || engine.toFuncky('')
        '"funcky:lists".drop "ab" 0'                                                                                                                                                                                                         || engine.toFuncky('ab')
        '"funcky:lists".drop "ab" 1'                                                                                                                                                                                                         || engine.toFuncky('b')
        '"funcky:lists".drop "ab" 2'                                                                                                                                                                                                         || engine.toFuncky('')
        '"funcky:lists".drop "ab" 3'                                                                                                                                                                                                         || engine.toFuncky('')
    }
