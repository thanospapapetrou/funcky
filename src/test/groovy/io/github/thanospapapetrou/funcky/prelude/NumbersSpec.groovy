...
class NumbersSpec extends BaseSpec {
    ...
    def 'Test rounding modes'(final String expression, final FunckyValue result) {
        ...
        result << (RoundingMode.values()*.ordinal().collect(BigDecimal.&new).collect({new FunckyNumber(it)}) + ([NUMBER] * RoundingMode.values().size()))
    }
    ...
    def 'Test plus'(final String expression, final FunckyValue result) {
        ...
        where:
        expression                                  || result
        '"funcky:numbers".plus'                     || new Numbers().$plus
        '"funcky:types".type "funcky:numbers".plus' || FUNCTION(NUMBER, NUMBER)
    ...
    def 'Test minus'(final String expression, final FunckyValue result) {
        ...
        where:
        expression                                   || result
        '"funcky:numbers".minus'                     || new Numbers().$minus
        '"funcky:types".type "funcky:numbers".minus' || FUNCTION(NUMBER, NUMBER)
    ...
    def 'Test round'(final String expression, final FunckyValue result) {
        ...
        '"funcky:types".type "funcky:numbers".round'                                                               || FUNCTION(NUMBER, NUMBER, NUMBER, NUMBER)
    ...
    def 'Test add'(final String expression, final FunckyValue result) {
        ...
        where:
        expression                                                                      || result
        '"funcky:numbers".add'                                                          || new Numbers().$add
        '"funcky:types".type "funcky:numbers".add'                                      || FUNCTION(NUMBER, NUMBER, NUMBER)
        '"funcky:types".type ("funcky:numbers".add 1)'                                  || FUNCTION(NUMBER, NUMBER)
    ...
    def 'Test subtract'(final String expression, final FunckyValue result) {
        ...
        where:
        expression                                                                           || result
        '"funcky:numbers".subtract'                                                          || new Numbers().$subtract
        '"funcky:types".type "funcky:numbers".subtract'                                      || FUNCTION(NUMBER, NUMBER, NUMBER)
        '"funcky:types".type ("funcky:numbers".subtract 1)'                                  || FUNCTION(NUMBER, NUMBER)
        '"funcky:commons".string ("funcky:numbers".subtract ("funcky:commons".error "foo"))' || new FunckyJavaConverter().convert('"funcky:numbers".subtract ("funcky:commons".error "foo")')
    ...
    def 'Test multiply'(final String expression, final FunckyValue result) {
        ...
        where:
        expression                                                                           || result
        '"funcky:numbers".multiply'                                                          || new Numbers().$multiply
        '"funcky:types".type "funcky:numbers".multiply'                                      || FUNCTION(NUMBER, NUMBER, NUMBER)
        '"funcky:types".type ("funcky:numbers".multiply 1)'                                  || FUNCTION(NUMBER, NUMBER)
        '"funcky:commons".string ("funcky:numbers".multiply ("funcky:commons".error "foo"))' || new FunckyJavaConverter().convert('"funcky:numbers".multiply ("funcky:commons".error "foo")')
    ...
    def 'Test divide'(final String expression, final FunckyValue result) {
        ...
        where:
        expression                                                                             || result
        '"funcky:numbers".divide'                                                              || new Numbers().$divide
        '"funcky:types".type "funcky:numbers".divide'                                          || FUNCTION(NUMBER, NUMBER, NUMBER, NUMBER, NUMBER)
        '"funcky:types".type ("funcky:numbers".divide 1)'                                      || FUNCTION(NUMBER, NUMBER, NUMBER, NUMBER)
        '"funcky:types".type ("funcky:numbers".divide 1 2)'                                    || FUNCTION(NUMBER, NUMBER, NUMBER)
        '"funcky:types".type ("funcky:numbers".divide 1 2 3)'                                  || FUNCTION(NUMBER, NUMBER)
        '"funcky:commons".string ("funcky:numbers".divide ("funcky:commons".error "foo"))'     || new FunckyJavaConverter().convert('"funcky:numbers".divide ("funcky:commons".error "foo")')
        '"funcky:commons".string ("funcky:numbers".divide 1 ("funcky:commons".error "foo"))'   || new FunckyJavaConverter().convert('"funcky:numbers".divide 1 ("funcky:commons".error "foo")')
        '"funcky:commons".string ("funcky:numbers".divide 1 2 ("funcky:commons".error "foo"))' || new FunckyJavaConverter().convert('"funcky:numbers".divide 1 2 ("funcky:commons".error "foo")')
    ...
    def 'Test modulo'(final String expression, final FunckyValue result) {
        ...
        '"funcky:types".type "funcky:numbers".modulo'                                                             || FUNCTION(NUMBER, NUMBER, NUMBER)
    ...
    def 'Test byte'(final String expression, final FunckyValue result) {
        ...
        where:
        expression                                  || result
        '"funcky:numbers".byte'                     || new Numbers().$byte
        '"funcky:types".type "funcky:numbers".byte' || FUNCTION(NUMBER, NUMBER)
    ...
    def 'Test short'(final String expression, final FunckyValue result) {
        ...
        where:
        expression                                   || result
        '"funcky:numbers".short'                     || new Numbers().$short
        '"funcky:types".type "funcky:numbers".short' || FUNCTION(NUMBER, NUMBER)
    ...
    def 'Test int'(final String expression, final FunckyValue result) {
        ...
        where:
        expression                                 || result
        '"funcky:numbers".int'                     || new Numbers().$int
        '"funcky:types".type "funcky:numbers".int' || FUNCTION(NUMBER, NUMBER)
    ...
    def 'Test long'(final String expression, final FunckyValue result) {
        ...
        where:
        expression                                   || result
        '"funcky:numbers".long'                      || new Numbers().$long
        '"funcky:types".type "funcky:numbers".long'  || FUNCTION(NUMBER, NUMBER)
    ...
    def 'Test float'(final String expression, final FunckyValue result) {
        ...
        where:
        expression                                   || result
        '"funcky:numbers".float'                     || new Numbers().$float
        '"funcky:types".type "funcky:numbers".float' || FUNCTION(NUMBER, NUMBER)
    ...
    def 'Test double'(final String expression, final FunckyValue result) {
        ...
        where:
        expression                                    || result
        '"funcky:numbers".double'                     || new Numbers().$double
        '"funcky:types".type "funcky:numbers".double' || FUNCTION(NUMBER, NUMBER)
    ...
    def 'Test sum'(final String expression, final FunckyValue result) {
        ...
        '"funcky:types".type "funcky:numbers".sum'                            || FUNCTION(LIST(NUMBER), NUMBER)
    ...
    def 'Test product'(final String expression, final FunckyValue result) {
        ...
        '"funcky:types".type "funcky:numbers".product'                            || FUNCTION(LIST(NUMBER), NUMBER)
